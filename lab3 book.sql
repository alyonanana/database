...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 01 2022 г., 19:56
...
(50, 3851, 'Yes', 'Захист інформації та безпека комп\'ютерних систем\r\n', 26.00, 'DiaSoft', 480, '84х108/16', '2022-04-01', 5000, 'Використання ПК в цілому', 'Захист і безпека ПК'),
...
(222, 235, 'Yes', 'Інформаційні системи і структури даних', NULL, 'КиєвоМогилянська академія', 288, '60х90/16', '2022-04-01', 400, 'Використання ПК в цілому', 'Інші книги'),
...
(1234, 9876, 'Yes', 'New book 1', 32.00, 'Alyona Chub', 345, '70х100/16', '2022-04-01', 2000, 'Chto-to', 'Kakaya-to'),
(2345, 8765, 'Yes', 'Name book 2', 33.00, 'Alyona Chub', NULL, NULL, '2022-04-01', NULL, 'Chto-to', 'Kakaya-to');
